...
"><head>
    ...
    <style>
        ...
        .navbar.fontBlack .navbar-nav > li > a {
            color: white;
        }
        /** end nav **/
        ...
        .item-icon {
            ...
            box-shadow: -3px 0 15px rgba(0, 0, 0, 0.44);
            border-radius: 24px;
        }
    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="liPortfolio"><a href="index.html#portfilios">PRODUCTS</a></li>
                <li class="liService active"><a href="index.html#services">SERVICES</a></li>
...
<div class="container">
    <div class="row" style="width: 980px; margin: 0 auto; margin-top: 104px;">
        ...
        <div class="col-lg-5 col-md-5">
            ...
            <img src="service_img/mobile/samsung.png" class="item-icon2 fadeInDown animated">
        </div>
    </div>
</div>
</body>
